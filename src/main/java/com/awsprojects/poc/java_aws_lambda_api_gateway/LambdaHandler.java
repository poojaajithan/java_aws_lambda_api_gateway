...
public class LambdaHandler implements RequestHandler<APIGatewayProxyRequestEvent, APIResponse>
{
	...
	private APIResponse buildResponse(Context context) 
	{
        ...
        try 
        {
			body = new ObjectMapper().writeValueAsString(buildEmployeeList());
		} 
	...
	{
		return Stream.of(new Employee(100, "Lipsa Patra", "lipsa@gmail.com"),
                ...
                new Employee(104, "Jasmine Gupta", "jasmine@gmail.com")).collect(Collectors.toList());
	}
